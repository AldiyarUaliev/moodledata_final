...
class __Mustache_c8cc4510f21ada261d68fd6aa0434f13 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div data-region="filter" class="d-flex align-items-center flex-wrap mb-2" aria-label="';
        // 'str' section
...
';
        ...
        $buffer .= $this->section4e6f76c511878bfa40231982493bf2ad($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section4e6f76c511878bfa40231982493bf2ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
