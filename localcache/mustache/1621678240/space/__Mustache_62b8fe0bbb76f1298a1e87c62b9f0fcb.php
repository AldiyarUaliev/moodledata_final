...
class __Mustache_62b8fe0bbb76f1298a1e87c62b9f0fcb extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <form>
';
        $buffer .= $indent . '            <fieldset class="form-group row no-gutters">
';
        $buffer .= $indent . '                <div class="form-check fp-linktype-2 pl-0">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="form-check fp-linktype-1 pl-0">
';
        $buffer .= $indent . '                    <label class="form-check-label">
';
        $buffer .= $indent . '                        <input class="form-check-input" type="radio">
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="form-check fp-linktype-4 pl-0">
';
        $buffer .= $indent . '                    <label class="form-check-label">
';
        $buffer .= $indent . '                        <input class="form-check-input" type="radio">
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="form-check fp-linktype-8 pl-0">
';
        $buffer .= $indent . '                    <label class="form-check-label">
';
        $buffer .= $indent . '                        <input class="form-check-input" type="radio">
...
';
        ...
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="form-group row no-gutters">
';
        $buffer .= $indent . '                <div class="fp-select-buttons">
';
        $buffer .= $indent . '                    <button class="fp-select-confirm btn-primary btn mr-2">';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section8d1e8b5df863535233c5ae53c44b0cca($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '                    <button class="fp-select-cancel btn-secondary btn ml-2">';
        // 'str' section
        $value = $context->find('str');
...
';
        ...
        $buffer .= '</strong><span class="fp-value"></span></div>
';
...
';
        ...
        $buffer .= '</strong><span class="fp-value" dir="ltr"></span></div>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
