...
class __Mustache_dcc49ee986f3094ddf6bc1bd705282b1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="dropdown mb-1 d-flex ml-auto">
';
        $buffer .= $indent . '    <button id="displaydropdown" type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
';
