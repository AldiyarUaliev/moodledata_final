...
class __Mustache_4fbb979d4a63ba470cca42cf79b89fed extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="fp-repo-area col-12 px-0 nav nav-pill" role="tablist">
';
        $buffer .= $indent . '                <div class="fp-repo nav-item mx-1 my-1" role="tab" aria-selected="false" tabindex="-1">
';
...
';
        $buffer .= $indent . '            <div class="fp-repo-items roudned" tabindex="0">
';
        $buffer .= $indent . '                <div class="fp-navbar card mb-1 clearfix icon-no-spacing">
';
        $buffer .= $indent . '                    <div>
';
