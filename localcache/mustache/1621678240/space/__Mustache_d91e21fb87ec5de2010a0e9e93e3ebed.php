...
class __Mustache_d91e21fb87ec5de2010a0e9e93e3ebed extends Mustache_Template
{
...
';
        $buffer .= $indent . '                                            \'                    <a  style="text-align: center" href="http://localhost/kyran_final/local/speciality/spec_info.php?id=\'+jsonData.test[prop]["id"]+\'" class="btn btn-primary">Толығырақ</a>\\n\' +
';
        $buffer .= $indent . '                                            \'                </div>\\n\' +
';
        $buffer .= $indent . '                                            \'            </div>\\n\' +
