...
class __Mustache_66e4acfe676ecaf0fcbf0cbc54e944ac extends Mustache_Template
{
...
';
        $buffer .= $indent . '<h6 style="color: red">Қызыл домалаққа басып, осы график астында ЖОО тізімі бар кесте шығады</h6>
';
        $buffer .= $indent . '<div class="container">
';
        $buffer .= $indent . '
