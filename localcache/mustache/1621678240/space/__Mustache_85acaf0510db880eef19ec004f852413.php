...
class __Mustache_85acaf0510db880eef19ec004f852413 extends Mustache_Template
{
...
';
        // 'error' section
        $value = $context->find('error');
        $buffer .= $this->section964866b0b5d6a850526c501b00871011($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        // 'js' section
    ...
    private function section964866b0b5d6a850526c501b00871011(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
