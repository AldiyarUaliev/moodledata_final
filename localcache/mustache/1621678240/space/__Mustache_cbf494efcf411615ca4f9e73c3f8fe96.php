...
class __Mustache_cbf494efcf411615ca4f9e73c3f8fe96 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="popover-region-toggle nav-link"
';
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section5d10c35e8b20ee15592b58140f113c6a($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</li>
';
    ...
    private function section5d10c35e8b20ee15592b58140f113c6a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <a class="see-all-link btn btn-sm btn-primary"
                    href="{{{.}}}">
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <a class="see-all-link btn btn-sm btn-primary"
';
                $buffer .= $indent . '                    href="';
