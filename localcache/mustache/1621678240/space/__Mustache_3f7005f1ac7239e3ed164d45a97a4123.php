...
class __Mustache_3f7005f1ac7239e3ed164d45a97a4123 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <p class="card-text">Жалақы: <b>';
        $value = $this->resolveValue($context->findDot('result.salary'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</b></p>
';
        $buffer .= $indent . '                        <p class="card-text">Сұраныс: <b>';
...
';
        $buffer .= $indent . '                    <div class="card-body">
';
        $buffer .= $indent . '                        <h5 class="card-title">Код: <b>';
        $value = $this->resolveValue($context->findDot('result.code'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</b></h5>
';
        $buffer .= $indent . '                        <p class="card-text">Мин. ұпай: <b>';
        $value = $this->resolveValue($context->findDot('result.point'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</b></p>
';
        $buffer .= $indent . '                        <p class="card-text">Грант саны: <b>';
