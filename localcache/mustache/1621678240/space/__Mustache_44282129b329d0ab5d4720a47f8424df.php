...
class __Mustache_44282129b329d0ab5d4720a47f8424df extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<h1>ЖОО тізімі</h1>
';
        $buffer .= $indent . '<style>
';
...
';
        $buffer .= $indent . '            <label>Қаланы тандау</label>
';
        $buffer .= $indent . '            <select id="first_subject">
';
        $buffer .= $indent . '                <option value="0">Барлық аудан</option>
';
        $buffer .= $indent . '                <option value="1">Нур-Султан</option>
';
        $buffer .= $indent . '                <option value="2">Алматы</option>
';
...
';
        $buffer .= $indent . '            <input type="text" placeholder="Аты бойынша іздеу"  id="pointText">
';
        $buffer .= $indent . '        </div>
';
...
';
        $buffer .= $indent . '            url: \'univerListsForSearch.php\',
';
...
';
        $buffer .= $indent . '        var citys =  $(\'#first_subject\').val();
';
        $buffer .= $indent . '        var codes =   $(\'#pointText\').val();
';
        $buffer .= $indent . '        if(!codes){
';
        $buffer .= $indent . '    codes = undefined;
';
        $buffer .= $indent . '        }
';
        $buffer .= $indent . '        console.log(citys+":"+codes);
';
        $buffer .= $indent . '        $.ajax({
';
        $buffer .= $indent . '            type: "POST",
';
        $buffer .= $indent . '            url: \'filterUniver.php\',
';
        $buffer .= $indent . '            data: {city: citys,
';
        $buffer .= $indent . '                code:codes
';
        $buffer .= $indent . '            },
';
        $buffer .= $indent . '            success: function (response) {
