...
class __Mustache_9ab3bf4621cc0477c7acc8a56837f68f extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="form-group row justify-content-end no-gutters">
';
        $buffer .= $indent . '            <button class="fp-file-download badge badge-link badge-secondary m-1 border-0"><i class="fas fa-download mr-1"></i> ';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section95ff3701934939e1eb7bd2c28e3ee1b9($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-delete badge badge-link badge-danger m-1 border-0"><i class="far fa-trash-alt mr-1"></i> ';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section8f92e409dad2d31675245b12b8825d4e($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-setmain badge badge-link badge-secondary m-1 border-0">';
        // 'str' section
        $value = $context->find('str');
...
';
        ...
        $buffer .= '</span>
';
        $buffer .= $indent . '            <button class="fp-file-zip badge badge-link badge-secondary m-1 border-0"><i class="fas fa-file-archive mr-1"></i> ';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->sectionB38288f316bd094496a8d2cfdfaa803d($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-unzip badge badge-link badge-secondary m-1 border-0">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                    <label class="form-control-label col-4">';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section59a2a4641027716ff85403c2d5e94fc1($context, $indent, $value);
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-8"><input class="form-control" type="text"/></div>
';
        $buffer .= $indent . '                </div>
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '        <div class="fp-select-buttons form-group mb-0">
';
        $buffer .= $indent . '            <button class="fp-file-update btn-primary btn m-r-1">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '          <div class="fp-thumbnail col m-0"></div>
';
        $buffer .= $indent . '          <div class="col m-0 px-4 py-3 alert alert-warning fp-fileinfo">
';
