...
class __Mustache_57ffad5716381760f5e1e230ff6849e9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '" class="form-group row no-gutters ';
        // 'error' section
...
';
        ...
        $buffer .= $indent . '        <span class="float-sm-right text-nowrap ml-1">
';
        $buffer .= $indent . '            ';
        // 'required' section
