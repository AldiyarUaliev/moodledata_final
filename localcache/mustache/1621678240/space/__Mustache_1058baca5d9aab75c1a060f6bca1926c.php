...
class __Mustache_1058baca5d9aab75c1a060f6bca1926c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<label class="my-2 d-inline-flex custom-control ios-switch form-check-inline ';
        // 'error' section
...
';
        ...
        $value = $this->resolveValue($context->findDot('element.name'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" class="ios-switch-control-input form-check-input ';
        $value = $this->resolveValue($context->findDot('element.extraclasses'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '"
';
...
';
        ...
        $buffer .= $this->section91997124ea4a8213c9d3bbc2c9d03265($context, $indent, $value);
        $buffer .= $indent . '    ';
...
';
        // 'error' section
        $value = $context->find('error');
        $buffer .= $this->section5f16ccb7e352df78a78286324f9e77ba($context, $indent, $value);
        // 'element.frozen' section
        $value = $context->findDot('element.frozen');
        $buffer .= $this->section4d504ef9dc4f036b2972f52db3e8c161($context, $indent, $value);
        $buffer .= $indent . '    ';
...
';
        ...
        $buffer .= $this->section2182206da97ad11d0a05d43abf4ff5f9($context, $indent, $value);
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionC8ba0c6a5158d9f63fda6fa4969db273($context, $indent, $value);
        }
...
';
    ...
    private function section91997124ea4a8213c9d3bbc2c9d03265(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section5f16ccb7e352df78a78286324f9e77ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section4d504ef9dc4f036b2972f52db3e8c161(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2182206da97ad11d0a05d43abf4ff5f9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC8ba0c6a5158d9f63fda6fa4969db273(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_space/form-display-errors\'], function(module) {
';
