...
class __Mustache_fc742cdf6a5d1a00ed483782863a3802 extends Mustache_Template
{
...
';
        // 'title' section
        $value = $context->find('title');
        $buffer .= $this->sectionC957c9b58e3d42562dd107634cd74114($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'hascontrols' section
        $value = $context->find('hascontrols');
        $buffer .= $this->section4700e2f839047ccdc6823dc29123cab3($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionC957c9b58e3d42562dd107634cd74114(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <h5 id="instance-{{blockinstanceid}}-header" class="card-title">{{{title}}}</h5>
        ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
...
';
    ...
    private function section4700e2f839047ccdc6823dc29123cab3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
