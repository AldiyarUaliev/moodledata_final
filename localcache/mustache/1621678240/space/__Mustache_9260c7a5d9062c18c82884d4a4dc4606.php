...
class __Mustache_9260c7a5d9062c18c82884d4a4dc4606 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <p class="card-text" style="text-align: center">';
...
';
        $buffer .= $indent . '    <div><h6 style="color:red">Бұл графикте, Сіздің әр тапсырған ҰБТ нәтижелерінің
';
        $buffer .= $indent . '        жалпы баллы төртбұрыш болып көрсетіліп тұр. Сол тесттегі қатемен жұмыс жасау үшің,
';
        $buffer .= $indent . '        сол төртбұрышты шертіңіз</h6></div>
';
        $buffer .= $indent . '    <br>
';
...
';
        $buffer .= $indent . '<h6 style="color: red">Қызыл доңғалақ шар-ға басып, осы график астында - ЖОО тізімі бар кесте шығады</h6>
';
        $buffer .= $indent . '<div class="container">
';
        $buffer .= $indent . '
