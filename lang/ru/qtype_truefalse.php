...
/**
 * Strings for component 'qtype_truefalse', language 'ru', version '3.10'.
 *
...
$string['correctanswerfalse'] = 'Правильный ответ: Неверно';
$string['correctanswertrue'] = 'Правильный ответ: Верно';
$string['false'] = 'Неверно';
$string['feedbackfalse'] = 'Комментарий для ответа «Неверно»';
$string['feedbacktrue'] = 'Комментарий для ответа «Верно»';
