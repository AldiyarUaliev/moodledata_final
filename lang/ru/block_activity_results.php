...
/**
 * Strings for component 'block_activity_results', language 'ru', version '3.10'.
 *
...
$string['defaultdecimalplaces'] = 'Десятичных знаков';
$string['defaultdecimalplaces_desc'] = 'Количество знаков после запятой,  отображаемых по умолчанию';
$string['defaultgradedisplay'] = 'Отображать оценки как';
$string['defaultgradedisplay_desc'] = 'Как должны по умолчанию отображаться оценки?';
$string['defaulthighestgrades'] = 'Показать по умолчанию наивысшие оценки';
$string['defaulthighestgrades_desc'] = 'Сколько наивысших оценок должно быть показано по умолчанию?';
$string['defaultlowestgrades'] = 'Показать по умолчанию самые низкие оценки';
$string['defaultlowestgrades_desc'] = 'Сколько самых низких оценок должно быть показано по умолчанию?';
$string['defaultnameoptions'] = 'Конфиденциальность результатов';
$string['defaultnameoptions_desc'] = 'Как по умолчанию следует идентифицировать студентов?';
$string['defaultshowgroups'] = 'По умолчанию показать группы';
$string['defaultshowgroups_desc'] = 'Показывать по умолчанию группы вместо студентов (только если элементы курса поддерживают группы)';
...
$string['worstgroupgrade'] = 'Группа с самым низким средним:';
$string['worstgroupgrades'] = 'Группы ({$a}) с самым низким средним:';
