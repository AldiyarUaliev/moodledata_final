...
/**
 * Strings for component 'qtype_numerical', language 'ru', version '3.10'.
 *
...
$string['answererror'] = 'Погрешность';
...
$string['manynumerical'] = 'Единицы измерения необязательны. Если они будут введены, то при оценивании ответа будет использоваться первая единица измерения.';
...
$string['unitx'] = 'Единица измерения {no}';
...
$string['xmustbenumeric'] = '{$a} должно быть числом.';
$string['xmustnotbenumeric'] = '{$a} не может быть числом.';
