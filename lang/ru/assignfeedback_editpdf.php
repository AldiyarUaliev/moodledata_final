...
/**
 * Strings for component 'assignfeedback_editpdf', language 'ru', version '3.10'.
 *
...
$string['commentindex'] = 'Индекс комментариев';
...
$string['privacy:metadata:colourpurpose'] = 'Цвет комментария или аннотации';
$string['privacy:metadata:conversionpurpose'] = 'Файлы преобразуются в PDF, чтобы можно было их комментировать.';
$string['privacy:metadata:filepurpose'] = 'Хранит аннотированный PDF с отзывом для пользователя.';
$string['privacy:metadata:rawtextpurpose'] = 'Хранит исходный текст для быстрых данных.';
$string['privacy:metadata:tablepurpose'] = 'Хранит указанные преподавателем комментарии для списка быстрого выбора';
$string['privacy:metadata:userid'] = 'ID пользователя.';
$string['privacy:path'] = 'Отзыв в PDF';
$string['rectangle'] = 'Прямоугольник';
$string['red'] = 'Красный';
$string['result'] = 'Результат:';
$string['rotateleft'] = 'Повернуть на 90 градусов влево';
