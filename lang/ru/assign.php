...
/**
 * Strings for component 'assign', language 'ru', version '3.10'.
 *
 * @package     assign
 * @category    string
...
$string['duedate_help'] = 'Время завершения задания. Ответы, отправленные после этой даты, будут помечены как просроченные. Установите дату завершения назначения, чтобы предотвратить отправку после определенной даты.';
...
$string['sendstudentnotifications_help'] = 'При включенном параметре студенты получают сообщение о обновлении оценки или отзыва.  Если для этого задания включен процесс оценивания, то уведомления не будут отправляться до тех пор, пока оценка не станет «Опубликованной».';
...
$string['submissionstatementteamsubmissionallsubmit'] = 'Подтверждающее заявление к групповому ответу на задание, где представлены все участники группы';
...
$string['submissionstatementteamsubmissionallsubmitdefault'] = 'Этот является моей собственной работой в качестве члена группы, за исключением случаев, когда я признал использование работ других людей.';
