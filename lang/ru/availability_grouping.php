...
/**
 * Strings for component 'availability_grouping', language 'ru', version '3.10'.
 *
...
$string['description'] = 'Разрешить только студентам, которые относятся к группе в определенном потоке.';
