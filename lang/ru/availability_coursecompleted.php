...
/**
 * Strings for component 'availability_coursecompleted', language 'ru', version '3.10'.
 *
...
$string['description'] = 'Доступ только для тех студентов кто уже (или еще не) завершил курс';
$string['getdescription'] = 'Вы завершили этот курс';
