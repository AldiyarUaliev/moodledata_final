...
/**
 * Strings for component 'qtype_ddimageortext', language 'ru', version '3.10'.
 *
...
$string['draggableitems'] = 'Перемещаемые элементы';
...
===
Вопросы с перетаскиванием на изображение требуют, чтобы респондент перетаскивал изображения или текстовые метки в определенные зоны на фоновом изображении. Перетаскиваемые элементы могут быть сгруппированы так, чтобы все элементы в определенной группе были окрашены так же, как и соответствующие им зоны. Перетаскиваемые предметы, отмеченные как «неоднократные», могут быть размещены более чем в одной зоне.';
...
Примечание. Этот тип вопросов недоступен для пользователей с ослабленным зрением.';
...
$string['privacy:metadata'] = 'Плагин «Тип вопроса Перетаскивание на изображение» не хранит никаких персональных данных.';
