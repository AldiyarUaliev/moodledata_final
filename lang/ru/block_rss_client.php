...
/**
 * Strings for component 'block_rss_client', language 'ru', version '3.10'.
 *
...
$string['rss_client:myaddinstance'] = 'Добавлять новый блок «Внешние RSS-ленты» на страницу «Личный кабинет»';
