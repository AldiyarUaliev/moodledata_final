...
/**
 * Strings for component 'assignfeedback_offline', language 'ru', version '3.10'.
 *
...
$string['invalidgradeimport'] = 'Moodle не смогла прочитать загруженную ведомость оценок. Убедитесь, что она сохранена в формате CSV (значениям разделенные запятыми) и повторите попытку.';
