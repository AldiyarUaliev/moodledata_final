...
/**
 * Strings for component 'hvp', language 'ru', version '3.10'.
 *
 * @package     hvp
 * @category    string
...
$string['messageprovider:confirmation'] = 'Подтверждение Ваших вкладов H5P';
$string['messageprovider:submission'] = 'Оповещение о вкладах H5P';
...
$string['modulenameplural'] = 'Интреактивный контент';
