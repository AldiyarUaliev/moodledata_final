...
/**
 * Strings for component 'block_grade_me', language 'ru', version '3.10'.
 *
...
$string['grade_me:myaddinstance'] = 'Добавлять новый блок «Проверь меня!» на страницу «Моя домашняя страница»';
