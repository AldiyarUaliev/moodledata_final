...
/**
 * Strings for component 'format_tiles', language 'ru', version '3.10'.
 *
...
$string['addsections'] = 'Добавить плитки';
...
$string['allowlabelconversion'] = 'Разрешить преобразование пояснений в страницы (экспериментально)';
$string['allowlabelconversion_desc'] = 'При включенном параметре учителям с правами редактирования для каждого пояснения в выпадающем списке будет добавлен параметр преобразования пояснения в страницу. Это экспериментальный параметр.';
...
$string['basecolour_help'] = 'Заданный здесь цвет будет использоваться для всех плиток в курсе';
$string['blockedpopup'] = 'Ваш браузер заблокировал всплывающее окно. Пожалуйста, разрешите всплывающие окна с этого сайта, или нажмите на ссылку ниже, чтобы посетить сайт в этом окне';
$string['blockedpopuptitle'] = 'Заблокированное всплывающее окно';
$string['brandcolour'] = 'Цвет бренда';
$string['browserstorage'] = 'Хранилище браузера';
...
$string['colourname_descr'] = 'Имя для цвета (например, «Синий»), которое будет использоваться в выпадающих меню при выборе цвета для курса';
...
$string['converttopage'] = 'Преобразовать в страницу';
$string['converttopage_confirm'] = 'Вы уверены? Это действие нельзя отменить (при необходимости Вам нужно будет заново вручную создать пояснение).';
...
$string['experimentalsetting'] = '(экспериментальная установка)';
$string['fileaddedtobottom'] = 'Файл добавлен в конец раздела';
$string['filenoshowtext'] = 'Если файл здесь не появляется, пожалуйста, воспользуйтесь кнопками справа для скачивания или просмотра в новом окне.';
...
$string['hovercolour'] = 'Цвет плитки при наведении курсора';
$string['hovercolour_descr'] = 'Цвет, которым будут показаны плитки при наведении на них курсора';
...
$string['icontitle-number_1'] = 'Число 1';
$string['icontitle-number_10'] = 'Число 10';
$string['icontitle-number_2'] = 'Число 2';
$string['icontitle-number_3'] = 'Число 3';
$string['icontitle-number_4'] = 'Число 4';
$string['icontitle-number_5'] = 'Число 5';
$string['icontitle-number_6'] = 'Число 6';
$string['icontitle-number_7'] = 'Число 7';
$string['icontitle-number_8'] = 'Число 8';
$string['icontitle-number_9'] = 'Число 9';
...
$string['jsmaxstoreditems'] = 'Максимальное количество элементов в хранилище сессии в браузере';
$string['jsmaxstoreditems_desc'] = 'Когда пользователи просматривают основную страницу с плитками, браузер будет сохранять HTML для самой страницы обзора плиток и контент каждой плитки, пока число элементов не достигнет указанного здесь максимального числа. Это позволяет очень быстро реагировать при щелчке на новой плитке. Слишком большое значение может привести к переполнению хранилища браузера (хотя пока при тестировании такой проблемы не было).';
...
$string['jsstoredcontentdeletemins'] = 'Сохраненный контент сессии удалять через (минут)';
$string['jsstoredcontentdeletemins_desc'] = 'После каждого щелчка по плитке, чтобы держать место свободным для текущего HTML, браузер пользователя будет запускать очистку и <em>удалять</em> из хранилища сессии весь сохраненный контент старше указанного в этом поле (опираясь на то, что он больше не актуален и в любом случае нужна будет новая копия с сервера)';
$string['jsstoredcontentexpirysecs'] = 'Срок жизни сохраненного контента сессии истекает через (секунд)';
$string['jsstoredcontentexpirysecs_desc'] = 'Когда пользователь щелкает по плитке, если контент в хранилище сессии в браузере старше этого значения, он все равно будет показан, но будет отправлен фоновый запрос на сервер, чтобы заменить этот контент свежей копией. Это разрешает последующие обновления курса, после того как браузер сохранил его копию. Если сохраненный контент моложе этого значения, то предполагается, что он актуальный и будет показан без выполнения запроса к серверу';
$string['labelconverted'] = 'Пояснение преобразовано';
...
$string['tilecolourgeneral_descr'] = 'Дополнительный цвет, предлагаемый пользователям как цвет плитки курса в выпадающем меню в параметре Управление курсом > Редактировать настройки. Оставьте поле пустым, чтобы убрать этот цвет.';
...
$string['tileselecttip'] = 'Вам не нужно беспокоиться, используя эту форму для смены значка плитки. Более простой способ это сделать — в курсе щелкнуть на значке, который Вы хотите изменить (режим редактирования должен быть включен)';
