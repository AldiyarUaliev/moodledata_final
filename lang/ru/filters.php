...
/**
 * Strings for component 'filters', language 'ru', version '3.10'.
 *
 * @package     filters
 * @category    string
...
$string['coursevalue'] = 'значение курса';
...
$string['limiterfor'] = 'ограничитель поля для {$a}';
