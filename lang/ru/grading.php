...
/**
 * Strings for component 'grading', language 'ru', version '3.10'.
 *
 * @package     grading
 * @category    string
...
$string['error:gradingunavailable'] = 'Неправильно задан расширенный метод оценки. Пожалуйста, проверьте все параметры выставления оценок в настройках форума.';
