...
/**
 * Strings for component 'availability', language 'ru', version '3.10'.
 *
...
$string['accessrestrictions'] = 'Ограничения доступа';
$string['addrestriction'] = 'Добавить ограничение...';
$string['and'] = 'и';
...
$string['hidden_all'] = 'Скрыто полностью, если пользователь не соответствует условиям';
$string['hidden_individual'] = 'Скрыто полностью, если пользователь не соответствует этому условию';
...
$string['listheader_multi_or'] = 'любому';
$string['listheader_sign_before'] = 'Студент';
