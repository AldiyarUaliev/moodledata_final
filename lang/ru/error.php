...
/**
 * Strings for component 'error', language 'ru', version '3.10'.
 *
 * @package     error
 * @category    string
...
$string['cannotdisableformat'] = 'Формат по умолчанию нельзя отключить.';
...
$string['cannotreprocessgrades'] = 'Не удается повторно обработать оценки для элемента {$a}';
...
$string['cannotviewcategory'] = 'У вас нет разрешения на просмотр этого списка курсов.';
...
$string['confirmationnotenabled'] = 'Подтверждение пользователя не включено на сайте';
...
$string['contenttypenotfound'] = 'Тип содержимого банка «{$a}» не существует или не распознан.';
...
$string['csvfileerror'] = 'Что-то не так с форматом CSV-файла. Проверьте соответствие количества заголовков и столбцов, а также правильность разделителя и кодировки файла. {$a}';
...
$string['csvnodata'] = 'Некорректный файл CSV - файл CSV имеет заголовки, но не содержит данных.';
...
$string['duplicateusername'] = 'Повторение логина - пропускаем запись';
$string['emailfail'] = 'Не удалось отправить сообщение электронной почты';
$string['enddatebeforestartdate'] = 'Дата окончания курса должна быть позже даты его начала.';
$string['error'] = 'Произошла ошибка';
$string['error_question_answers_missing_in_db'] = 'Не удалось найти ответ, соответствующий «{$a->answer}» в таблице question_answers базы данных. Это произошло во время восстановления из файла резервной копии вопроса с id {$a->filequestionid}, который в базе данных соответствует существующему вопросу с id {$a->dbquestionid}.';
...
$string['gradesneedregrading'] = 'Оценки курса должны быть пересчитаны';
...
$string['inplaceeditableerror'] = 'Ошибка вызова обработчика обновления';
...
$string['invalidcommentitemid'] = 'Неверный ID элемента комментария';
...
$string['invalidcontentid'] = 'Неверный ID контента';
$string['invalidcontext'] = 'Недопустимый контекст';
$string['invalidcountrycode'] = 'Неверный код страны: {$a}';
$string['invalidcourse'] = 'Ошибочный курс';
$string['invalidcourseformat'] = 'Неправильный формат курса';
...
$string['invaliddatarootpermissions'] = 'При попытке создать каталог обнаружены недопустимые разрешения. Включите отладку для выяснения подробностей.';
...
$string['invalidnumkey'] = 'Массив $conditions не может содержать числовые ключи. Исправьте код!';
...
$string['invalidscaleid'] = 'Неверный ID шкалы';
...
$string['invaliduserdata'] = 'Неправильные данные пользователя: {$a}';
...
$string['messageundeliveredbynotificationsettings'] = 'Сообщение не может быть отправлено, поскольку личные сообщения между пользователями (в настройках уведомлений) были отключены администратором сайта.';
...
$string['mnetlocal'] = 'Внешние пользователи MNET не могут входить в систему локально';
...
$string['movecatcontentstoselected'] = 'Часть содержимого категории нельзя переместить в выбранную категорию.';
...
$string['nopermissiontodelentry'] = 'Вы не можете удалить этот комментарий!';
...
$string['nostartdatenoenddate'] = 'Дата окончания курса может быть задана только при установленной дате начала курса.';
...
$string['pagenotexist'] = '<p> Необычная ошибка при просмотре несуществующей страницы: </p> {$a}';
$string['pagenotexisttitle'] = 'Ошибка 404: файл не найден';
...
$string['pluginunsupported'] = 'Плагин «{$a->pluginname}» {$a->pluginversion} не поддерживает эту версию Moodle {$a->moodleversion}. Ищите информацию о плагине, чтобы найти поддерживаемые версии.';
...
$string['privatefilesupload'] = 'Прямая загрузка в область личных файлов пользователя больше не поддерживается. Загружайте в область черновиков, а затем перемещайте файлы с помощью core_user::add_user_private_files';
...
$string['registrationdisabled'] = 'Регистрация отключена на сайте';
...
$string['sessionerroruser'] = 'Время Вашего сеанса истекло. Войдите в систему еще раз.';
...
$string['sessionexpired'] = 'Сессия истекла';
...
$string['storedfilecannotcreatefile'] = 'Невозможно создать файл локального пула файлов. Проверьте разрешения в DataRoot и наличие свободного места на диске.';
...
$string['storedfilecannotread'] = 'Не удалось прочитать файл. Файл либо не существует, либо неверно настроены права доступа к нему.';
...
$string['usernotfullysetup'] = 'Пользователь не полностью настроен';
...
$string['wrongusernamepassword'] = 'Неверный пользователь/пароль';
