...
/**
 * Strings for component 'qtype_ddmarker', language 'ru', version '3.10'.
 *
...
$string['dropzones_help'] = 'Зоны перетаскивания могут быть заданы координатами или перетащены в нужное место в предварительном просмотре выше.

Сначала выберите форму (круг, прямоугольник или многоугольник), чтобы добавить новую форму зоны перетаскивания в левый верхний угол предварительного просмотра. Может быть полезно свернуть раздел маркеров, чтобы вы могли видеть предварительный просмотр при редактировании зон перетаскивания.

Редактирование фигуры начинается с щелчка по фигуре в предварительном просмотре, чтобы отобразить маркеры редактирования. Вы можете перемещать фигуру за её центр, или регулировать размеры фигуры, используя её вершины.

Только для многоугольников: удерживание кнопки управления (кнопки управления на Mac) при нажатии на маркер вершины добавит новую вершину к многоугольнику. Сохраняйте форму многоугольника как можно более простой, без пересечения линий.

Информация: координаты трех фигур используются следующим образом:
...
* Многоугольник: x1, y1; х2, у2; ...; xn, yn <br /> например: <code> 20, 60; 100, 60; 20, 100 </code>

Выбор текста маркера добавит этот текст к фигуре в предварительном просмотре.';
...
Примечание. Этот тип вопросов недоступен для пользователей с плохим зрением.';
