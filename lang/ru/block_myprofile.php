...
/**
 * Strings for component 'block_myprofile', language 'ru', version '3.10'.
 *
...
$string['display_phone1'] = 'Показать номер телефона';
...
$string['privacy:metadata'] = 'Блок «Текущий пользователь» только показывает информацию о пользователе, вошедшем в систему, и сам по себе не хранит никаких данных.';
