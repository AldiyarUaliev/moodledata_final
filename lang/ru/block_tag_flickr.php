...
/**
 * Strings for component 'block_tag_flickr', language 'ru', version '3.10'.
 *
...
$string['configtitle'] = 'Заголовок блока Flickr';
...
$string['privacy:metadata:block_tag_flickr'] = 'Блок «Flickr» не хранит никаких персональных данных, но передает данные пользователя из Moodle в удаленную систему.';
$string['privacy:metadata:block_tag_flickr:tags'] = 'Значения тегов, отправляемых в формате CSV для поиска изображений на Flickr.';
