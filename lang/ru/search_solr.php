...
/**
 * Strings for component 'search_solr', language 'ru', version '3.10'.
 *
 * @package     search_solr
 * @category    string
...
$string['solrhttpconnectiontimeout_desc'] = 'Таймаут соединения HTTP — максимальное время в секундах, разрешенное для операции передачи данных HTTP.';
