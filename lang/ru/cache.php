...
/**
 * Strings for component 'cache', language 'ru', version '3.10'.
 *
 * @package     cache
 * @category    string
...
$string['cachedef_capabilities'] = 'Список системных требований';
$string['cachedef_completion'] = 'Статус завершения выполнения';
$string['cachedef_config'] = 'Настройки конфигурации';
$string['cachedef_contentbank_context_extensions'] = 'Разрешенные расширения и подключаемые к ним плагины в контексте банка контента';
$string['cachedef_contentbank_enabled_extensions'] = 'Разрешенные расширения и подключаемые к ним плагины в банке контента';
$string['cachedef_contextwithinsights'] = 'Контекст с инсайтами';
$string['cachedef_course_user_dates'] = 'Пользовательские даты для курсов, установленных в режиме относительных дат';
...
$string['cachedef_coursecompletion'] = 'Статус завершения курса';
...
$string['cachedef_fontawesomeiconmapping'] = 'Сопоставление значков для font awesome';
$string['cachedef_grade_categories'] = 'Запросы по категориям оценок';
...
$string['cachedef_postprocessedcss'] = 'Сообщение, обработанное с помощью CSS';
...
$string['cachedef_tags'] = 'Коллекции тегов и области';
$string['cachedef_temp_tables'] = 'Кэш временных таблиц';
$string['cachedef_user_group_groupings'] = 'Потоки и группы пользователя по курсам';
...
$string['localstorenotification'] = 'Этот кэш может быть безопасно связан с хранилищем, которое является локальным для каждого веб-сервера';
$string['lockdefault'] = 'По умолчанию';
$string['locking'] = 'Блокировка';
$string['locking_help'] = 'Блокировка — механизм, который ограничивает доступ к кэшированным данным таким образом, чтобы данные были доступны только одному процессу и предотвращает перезапись данных. Метод блокировки определяет как получить блокировку и проверить ее.';
...
$string['privacy:metadata:cachestore'] = 'Подсистема кеширования временно хранит данные по поручению других частей Moodle. Эти данные нельзя легко идентифицировать и срок их существования крайне короткий. Он служит как кэш данных, хранящихся где-то в Moodle, и потому уже должен управляться соответствующими компонентами Moodle.';
...
$string['sharedstorenotification'] = 'Этот кэш должен быть связан с хранилищем, которое является общим для всех веб-серверов';
