...
/**
 * Strings for component 'cohort', language 'ru', version '3.10'.
 *
 * @package     cohort
 * @category    string
...
$string['privacy:metadata:cohort_members'] = 'Информация о глобальной группе пользователя.';
$string['privacy:metadata:cohort_members:cohortid'] = 'ID глобальной группы';
$string['privacy:metadata:cohort_members:timeadded'] = 'Момент времени, когда пользователь был добавлен в глобальную группу';
$string['privacy:metadata:cohort_members:userid'] = 'ID пользователя, связанного с глобальной группой';
