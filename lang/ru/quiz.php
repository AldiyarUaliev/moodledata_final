...
/**
 * Strings for component 'quiz', language 'ru', version '3.10'.
 *
 * @package     quiz
 * @category    string
...
$string['canredoquestions_desc'] = 'Если параметр включен, то после ответа студентов на конкретный вопрос они увидят кнопку «Повторно ответить на вопрос».
Это позволяет задать им аналогичный вопрос (выбранный случайным образом) или повторить тот же вопрос без необходимости завершения теста и начала другой попытки. Такая возможность в основном полезна для тренировочных тестов.
...
$string['canredoquestions_help'] = 'Если параметр включен, то после ответа студентов на конкретный вопрос они увидят кнопку «Повторно ответить на вопрос».
Это позволяет задать им аналогичный вопрос (выбранный случайным образом) или повторить тот же вопрос без необходимости завершения теста и начала другой попытки. Такая возможность в основном полезна для тренировочных тестов.
Эта настройка влияет только на те вопросы и поведение (например, немедленный отзыв или интерактивный с несколькими попытками), где возможно завершение студентом вопроса до того, как попытка будет отправлена.';
$string['canredoquestionsyes'] = 'Да, предоставить возможность ответить на другой вопрос';
...
$string['completionminattempts'] = 'Минимальное количество попыток:';
$string['completionminattemptserror'] = 'Минимальное количество попыток должно быть меньше или равно разрешенному количеству попыток.';
$string['completionminattemptsgroup'] = 'Требуются попытки';
$string['completionpass'] = 'Требуется проходной балл';
$string['completionpass_help'] = 'При включенном параметре эта деятельность считается завершенной, если студент получает оценку не ниже проходного балла, заданного в разделе «Оценка» в настройках теста.';
...
$string['eventquizattemptregraded'] = 'Попытка теста заново оценена';
...
$string['gradetopassnotset'] = 'Для этого теста не задана проходная оценка. Её можно установить в разделе «Оценка» в настройках теста.';
...
$string['inactiveoverridehelp'] = '* Это переопределение неактивно, потому что доступ пользователя к тесту ограничен. Это может быть связано с назначением групп или ролей, другими ограничениями доступа или скрытым тестом.';
...
$string['indicator:cognitivedepthdef'] = 'Тест: познавательный аспект';
$string['indicator:cognitivedepthdef_help'] = 'Участник достиг этого процента познавательного взаимодействия, предлагаемого элементом курса «Тест» в течение этого интервала анализа (Уровни = Нет просмотра, Просмотр, Отправка, Просмотр отзыва, Комментарий на отзыв, Повторная отправка после просмотра отзыва)';
...
$string['indicator:socialbreadthdef'] = 'Тест: социальный аспект';
$string['indicator:socialbreadthdef_help'] = 'Участник достиг этого процента социальной активности, предлагаемой элементами Тест в течение этого интервала анализа (Уровни = нет участия, единственный участник, участник с другими)';
...
$string['invalidrandomslot'] = 'Неверный идентификатор места для случайного вопроса.';
...
$string['questiondeleted'] = 'Этот вопрос был удален. Пожалуйста, свяжитесь с преподавателем.';
...
$string['quizopenedon'] = 'Этот тест был открыт {$a}';
...
$string['quizreport'] = 'Отчет о тесте';
...
$string['selectattempt'] = 'Выбор попытки';
...
$string['updatequizslotswithrandomxofy'] = 'Обновление теста данными из «случайных» вопросов ({$a->done}/{$a->total})';
