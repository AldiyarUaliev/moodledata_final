...
/**
 * Strings for component 'block_timeline', language 'ru', version '3.10'.
 *
...
$string['nocoursesinprogress'] = 'Нет начатых курсов';
$string['noevents'] = 'Нет элементов курса с приближающимся сроком сдачи';
$string['overdue'] = 'Просрочены';
$string['pluginname'] = 'Шкала времени';
...
$string['timeline:myaddinstance'] = 'Добавлять новый блок «Шкала времени» на страницу «Личный кабинет»';
