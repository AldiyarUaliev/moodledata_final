...
/**
 * Strings for component 'mediagallery', language 'ru', version '3.10'.
 *
...
$string['colltypeinstructor'] = 'Коллекция инструктора';
...
$string['gallerythumbnail'] = 'Использовать как эскиз';
...
$string['maxitems'] = 'Максимум предметов в галерее';
$string['maxitemsreached'] = 'Максимальное количество добавленных предметов';
$string['mediagallery:viewall'] = 'Возможность просмотра всех галерей в медиа-коллекции';
...
$string['privacy:metadata:core_files'] = 'Теги, связанные с галереями медиа-коллекции или элементами';
