...
/**
 * Strings for component 'local_moodlemobileapp', language 'ru', version '3.10'.
 *
...
$string['addon.files.couldnotloadfiles'] = 'Файлы из списка не могут быть загружены';
$string['addon.files.emptyfilelist'] = 'Нет файлов для отображения';
$string['addon.files.erroruploadnotworking'] = 'К сожалению, в данный момент невозможно загрузить файлы на ваш сайт.';
...
$string['addon.mod_assign.userwithid'] = 'Пользователь с ID {{id}}';
...
$string['addon.mod_forum.refreshdiscussions'] = 'Обновить обсуждения';
...
$string['addon.notes.userwithid'] = 'Пользователя с ID {{id}}';
...
$string['core.cannotconnect'] = 'Не удается подключиться: Убедитесь, что вы правильно ввели URL-адрес и что ваш сайт использует Moodle {{$a}} или более поздней версии.';
...
$string['core.course.activitynotyetviewablesiteupgradeneeded'] = 'Установка Moodle вашей организации нуждается в обновлении.';
$string['core.course.allsections'] = 'Все разделы';
$string['core.course.askadmintosupport'] = 'Свяжитесь с администратором сайта и скажите ему, что хотите использовать активный элемент в приложении Moodle Mobile.';
$string['core.course.confirmdeletemodulefiles'] = 'Вы уверены, что хотите удалить эти файлы?';
...
$string['core.course.contents'] = 'Содержание';
...
$string['core.courses.confirmselfenrol'] = 'Вы уверены, что хотите записать себя на этот курс?';
...
$string['core.courses.errorselfenrol'] = 'Во время самостоятельной записи произошла ошибка.';
...
$string['core.courses.selfenrolment'] = 'Самостоятельная запись';
...
$string['core.login.contactyouradministrator'] = 'Свяжитесь с администратором вашего сайта для дальнейшей помощи.';
$string['core.login.contactyouradministratorissue'] = 'Пожалуйста, попросите администратора вашего сайта проверить следующую проблему: {{$a}}';
...
$string['core.login.invalidmoodleversion'] = 'Неверная версия Moodle. Минимальная требуемая версия - 2.4.';
...
$string['core.login.localmobileunexpectedresponse'] = 'Проверка Moodle Mobile Additional Features вернула неожиданный ответ. Вы будете аутентифицированы, используя стандартные мобильные сервисы.';
$string['core.login.loggedoutssodescription'] = 'Вам необходимо аутентифицироваться заново. Вам нужно войти на сайт под своей учётной записью в окне браузера.';
$string['core.login.loginbutton'] = 'Войти';
$string['core.login.logininsiterequired'] = 'Вы должны войти на сайт в окне браузера.';
...
$string['core.login.reconnectdescription'] = 'Ваш ключ аутентификации недействителен или срок его действия истек. Вам придется заново подключиться к сайту.';
$string['core.login.reconnectssodescription'] = 'Ваш ключ аутентификации недействителен или срок его действия истек. Вам придется заново зайти на сайт в окне браузера.';
...
$string['core.mainmenu.changesite'] = 'Сменить сайт';
$string['core.mainmenu.website'] = 'Сайт';
...
$string['core.settings.deletesitefiles'] = 'Вы уверены, что хотите удалить файлы, скачанные с сайта «{{sitename}}»?';
$string['core.settings.deletesitefilestitle'] = 'Удалить файлы сайта';
...
$string['core.settings.enablesyncwifi'] = 'Разрешить синхронизацию только по Wi-Fi';
$string['core.settings.errordeletesitefiles'] = 'Ошибка при удалении файлов сайта';
$string['core.settings.errorsyncsite'] = 'Ошибка синхронизации данных сайта. Проверьте интернет-соединение и повторите попытку.';
