...
/**
 * Strings for component 'lti', language 'ru', version '3.10'.
 *
 * @package     lti
 * @category    string
...
$string['contentitem'] = 'Сообщать о содержимом';
$string['contentitem_deeplinking_help'] = 'Если отмечено, то опция «Выбрать содержимое» станет доступной при добавлении внешнего инструмента.';
$string['contentitem_help'] = 'Если отмечено, то опция «Выбрать содержимое» станет доступной при добавлении внешнего инструмента.';
...
$string['lti:addinstance'] = 'Добавлять новые внешние приложения';
...
$string['organizationid'] = 'ID организации';
...
$string['organizationid_help'] = 'Уникальный идентификатор этого сайта Moodle. Обычно используется доменное имя организации.

Если это поле оставить пустым, то имя этого сайта Moodle будет использоваться как значение по умолчанию.';
...
$string['pluginadministration'] = 'Администрирование внешних инструментов';
...
$string['privacy:metadata:lti_submission:userid'] = 'ID пользователя, который отправил ответ на задание внешнего приложения';
...
$string['secure_launch_url_help'] = 'Подобен URL-адресу инструмента, но используется вместо него при необходимости высокого уровня безопасности. Moodle будет использовать безопасный URL-адрес вместо URL-адреса, если сайт Moodle доступен через SSL или если в конфигурации приложения задано - всегда запускать через SSL.
