...
/**
 * Strings for component 'tool_xmldb', language 'ru', version '3.10'.
 *
 * @package     tool_xmldb
 * @category    string
...
Настоятельно рекомендуется, чтобы у Вас был самый свежий (версия +) доступный релиз Moodle перед выполнением поиска неверных внешних ключей.
...
$string['numberincorrectwholepart'] = 'Слишком большая целая часть для числового поля';
