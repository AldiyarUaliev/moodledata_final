...
/**
 * Strings for component 'tool_behat', language 'ru', version '3.10'.
 *
 * @package     tool_behat
 * @category    string
...
$string['fieldvalueargument_help'] = 'Этот аргумент должен соответствовать значению поля. Есть много типов полей, простые, например: флажки или текстовая область или сложные, например - выбор даты. Подробную информацию об ожидаемых значениях полей см. в документации для разработчиков <a href="https://docs.moodle.org/dev/Acceptance_testing" target="_blank"> Acceptance_testing </a>.';
