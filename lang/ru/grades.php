...
/**
 * Strings for component 'grades', language 'ru', version '3.10'.
 *
 * @package     grades
 * @category    string
...
$string['aggregatesonly'] = 'Переключить на «только итоги»';
...
$string['full'] = 'Полный';
$string['fullmode'] = 'Переключить на «Полный вид»';
...
$string['gradesonly'] = 'Переключить на «Только оценки»';
...
$string['keephighestvalues'] = 'Взять {$a} самых высоких оценок';
...
$string['linktoactivity'] = 'Ссылка на элемент курса «{$a->name}» {$a->title}';
...
$string['missingitemtypeoreid'] = 'Ключ массива (itemtype или eid) не указан во втором параметре grade_edit_tree_column_select::get_item_cell($item, $params)';
...
$string['showingfullmode'] = 'Отображается полный вид';
...
$string['singleview'] = 'Отчет по пользователю для {$a}';
