...
/**
 * Strings for component 'quiz_responses', language 'ru', version '3.10'.
 *
...
$string['showthe'] = 'Показать';
$string['summaryofquestiontext'] = 'Резюме вопроса';
$string['summaryofresponse'] = 'Резюме данного ответа';
