...
/**
 * Strings for component 'data', language 'ru', version '3.10'.
 *
 * @package     data
 * @category    string
...
$string['modulename_help'] = 'Модуль «База данных» позволяет участникам создавать, обслуживать и искать записи из совокупности. Структура записей определяется учителем через количество полей. Типы полей включают флажки, переключатели, выпадающие списки, меню, текстовые области, гиперссылки, изображения и загружаемые файлы.
...
$string['requiredentrieswarning'] = 'Этот параметр был заменен параметром «Требовать записи» завершения элемента курса';
