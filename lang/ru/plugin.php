...
/**
 * Strings for component 'plugin', language 'ru', version '3.10'.
 *
 * @package     plugin
 * @category    string
...
$string['type_customfield_plural'] = 'Пользовательские поля';
...
$string['type_mlbackend'] = 'Механизм машинного обучения';
$string['type_mlbackend_plural'] = 'Механизмы машинного обучения';
...
$string['type_paygw'] = 'Платежный шлюз';
$string['type_paygw_plural'] = 'Платежные шлюзы';
$string['type_paygwmanage'] = 'Управление платежными шлюзами';
...
$string['validationmsg_pluginversiontoolow'] = 'Уже установлена более поздняя версия этого плагина.';
