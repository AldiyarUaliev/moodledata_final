...
/**
 * Strings for component 'theme_boost', language 'ru', version '3.10'.
 *
 * @package     theme_boost
 * @category    string
...
$string['privacy:metadata:preference:draweropennav'] = 'Настройки пользователя для скрытия или отображения раскрывающегося меню навигации.';
