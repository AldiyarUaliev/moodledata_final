...
/**
 * Strings for component 'form', language 'ru', version '3.10'.
 *
 * @package     form
 * @category    string
...
$string['err_maxfiles'] = 'Вы не можете прикрепить более чем {$a} файл(а,ов)';
$string['err_maxlength'] = 'Вы должны ввести сюда не более {$a->format} символов.';
...
$string['err_wrongfileextension'] = 'Некоторые файлы ({$a->wrongfiles}) не могут быть загружены на сервер. Разрешены только файлы следующих типов: {$a->allowlist.';
...
$string['suggestions'] = 'Предложения';
$string['time'] = 'Время';
