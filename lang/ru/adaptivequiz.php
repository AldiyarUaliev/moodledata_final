...
/**
 * Strings for component 'adaptivequiz', language 'ru', version '3.10'.
 *
...
$string['answer'] = 'Ответ';
$string['answerdistgraph_questiondifficulty'] = 'Уровень вопроса';
$string['answers_display_name'] = 'Ответы';
$string['attempt_questiondetails'] = 'Подробности вопроса';
...
$string['attempttotaltime'] = 'Общее время (чч:мм:сс)';
$string['bestscore'] = 'Лучший результат';
$string['bestscorestderror'] = 'Стандартная ошибка';
$string['browsersecurity'] = 'Безопасность браузера';
$string['closeattempt'] = 'Закрыть попытку';
$string['deleteattemp'] = 'Удалить попытку';
$string['downloadcsv'] = 'Скачать CSV';
$string['enterrequiredpassword'] = 'Введите требуемый пароль';
$string['errorclosingattempt'] = 'Запись попытки не найдена';
$string['errordeletingattempt'] = 'Запись попытки не найдена';
$string['formelementempty'] = 'Введите положительное целое число от 1 до 999';
$string['formelementnegative'] = 'Введите положительное число от 1 до 999';
$string['formelementnumeric'] = 'Введите числовое значение от 1 до 999';
$string['formlowlevelgreaterthan'] = 'Самый низкий уровень должен быть меньше самого высокого уровня';
...
$string['highestlevel'] = 'Самый высокий уровень сложности';
$string['na'] = 'н/д';
$string['name'] = 'Название';
$string['numright'] = 'Количество верных';
$string['numwrong'] = 'Количество неверных';
$string['percent_correct_display_name'] = '% Верных';
