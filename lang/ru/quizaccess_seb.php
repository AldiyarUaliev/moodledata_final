...
/**
 * Strings for component 'quizaccess_seb', language 'ru', version '3.10'.
 *
...
$string['cachedef_config'] = 'Кеш конфигурации SEB';
$string['cachedef_configkey'] = 'Кеш ключей конфигурации SEB';
...
$string['invalidkeys'] = 'Ключ конфигурации или ключи проверки браузера не могут быть проверены. Убедитесь, что вы используете браузер Safe Exam Browser с корректным файлом конфигурации.';
...
$string['pluginname'] = 'Правила доступа Safe Exam Browser';
...
$string['seb:bypassseb'] = 'Отключить требование просмотра теста в браузере Safe Exam.';
$string['seb:manage_filemanager_sebconfigfile'] = 'Изменить настройки SEB для теста: Выбрать конфигурационный файл SEB';
$string['seb:manage_seb_activateurlfiltering'] = 'Изменить настройки SEB для теста: Включить URL-фильтрацию';
$string['seb:manage_seb_allowedbrowserexamkeys'] = 'Изменять настройки SEB для теста: Разрешенные значения ключа браузера и экзамена';
$string['seb:manage_seb_allowreloadinexam'] = 'Изменить настройки SEB для теста: Разрешить перезагрузку';
$string['seb:manage_seb_allowspellchecking'] = 'Изменить настройки SEB для теста: Включить проверку правописания';
$string['seb:manage_seb_allowuserquitseb'] = 'Изменить настройки SEB для теста: Разрешить выход';
$string['seb:manage_seb_enableaudiocontrol'] = 'Изменить настройки SEB для теста: Включить управление звуком';
$string['seb:manage_seb_expressionsallowed'] = 'Изменить настройки SEB для теста: Разрешенные простые выражения';
$string['seb:manage_seb_expressionsblocked'] = 'Изменить настройки SEB для теста: Заблокированные простые выражения';
$string['seb:manage_seb_filterembeddedcontent'] = 'Изменить настройки SEB для теста: Фильтровать встроенный контент';
$string['seb:manage_seb_linkquitseb'] = 'Изменить настройки SEB для теста: Ссылка для выхода';
$string['seb:manage_seb_muteonstartup'] = 'Изменить настройки SEB для теста: Отключить звук при запуске';
$string['seb:manage_seb_quitpassword'] = 'Изменить настройки SEB для теста: Пароль для выхода';
$string['seb:manage_seb_regexallowed'] = 'Изменить настройки SEB для теста: Разрешенные регулярные выражения';
$string['seb:manage_seb_regexblocked'] = 'Изменить настройки SEB для теста: Заблокированные регулярные выражения';
$string['seb:manage_seb_requiresafeexambrowser'] = 'Изменить настройки SEB для теста: Требование использовать Safe Exam Browser';
$string['seb:manage_seb_showkeyboardlayout'] = 'Изменить настройки SEB для теста: Показать раскладку клавиатуры';
$string['seb:manage_seb_showreloadbutton'] = 'Изменить настройки SEB для теста: Показывать кнопку перезагрузки';
$string['seb:manage_seb_showsebdownloadlink'] = 'Изменить настройки SEB для теста: Показывать кнопку загрузки';
$string['seb:manage_seb_showsebtaskbar'] = 'Изменить настройки SEB для теста: Показывать панель задач';
$string['seb:manage_seb_showtime'] = 'Изменить настройки SEB для теста: Показывать время';
$string['seb:manage_seb_showwificontrol'] = 'Изменить настройки SEB для теста: Показывать управление Wi-Fi';
$string['seb:manage_seb_templateid'] = 'Изменить настройки SEB для теста: Выбрать шаблон SEB';
$string['seb:manage_seb_userconfirmquit'] = 'Изменить настройки SEB для теста: Подтверждение при выходе';
