...
/**
 * Strings for component 'availability_examus', language 'ru', version '3.10'.
 *
...
$string['fromdate'] = 'С:';
$string['identification_mode'] = 'Идентификация (идентификация человеком, автоматический прокторинг)';
$string['link'] = 'Архив';
...
$string['normal_mode'] = 'Нормальный (Прокторинг человеком)';
