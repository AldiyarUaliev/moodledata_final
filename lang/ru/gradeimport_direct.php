...
/**
 * Strings for component 'gradeimport_direct', language 'ru', version '3.10'.
 *
...
$string['direct:view'] = 'Импортировать оценки из электронной таблицы';
$string['pluginname'] = 'Вставка из электронной таблицы';
