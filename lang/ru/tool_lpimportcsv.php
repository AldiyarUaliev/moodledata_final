...
/**
 * Strings for component 'tool_lpimportcsv', language 'ru', version '3.10'.
 *
...
$string['descriptionformat'] = 'Формат описания';
...
$string['ruleoutcome'] = 'Правило навыка (необязательно)';
$string['ruletype'] = 'Тип правила (необязательно)';
$string['scaleconfiguration'] = 'Конфигурация шкалы';
$string['scalevalues'] = 'Значения шкалы';
