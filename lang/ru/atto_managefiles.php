...
/**
 * Strings for component 'atto_managefiles', language 'ru', version '3.10'.
 *
...
$string['privacy:metadata'] = 'Плагин atto_managefiles не хранит никаких персональных данных.';
$string['unusedfilesdesc'] = 'Следующие вложенные файлы не используются в тексте:';
$string['unusedfilesheader'] = 'Неиспользуемые файлы';
$string['unusedfilesremovalnotice'] = 'Все неиспользованные файлы будут автоматически удалены при сохранении изменений.';
