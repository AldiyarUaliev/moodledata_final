...
/**
 * Strings for component 'badges', language 'ru', version '3.10'.
 *
 * @package     badges
 * @category    string
...
$string['addbackpack'] = 'Добавить коллекцию наград';
...
$string['apiversion'] = 'Версия API поддерживается';
...
$string['backpackconnection_help'] = 'Подключение к коллекции наград позволяет вам делиться своими значками с этого сайта и отображать значки из вашей общедоступной коллекции наград на странице своего профиля на этом сайте.';
...
$string['backpackconnectionunexpectedresult'] = 'Не удалось подключится к Вашей коллекции наград. Пожалуйста, проверьте учетные данные и повторите попытку.';
...
$string['backpackemailverifyemailbody'] = 'Здравствуйте!

На сайте «{$a->sitename}» было запрошено новое подключение к Вашей коллекции наград OpenBadges с использованием Вашего адреса электронной почты.

Чтобы подтвердить это действие и активировать подключение к коллекции наград, пройдите по следующему адресу:

{$a->link}

В большинстве почтовых программ этот адрес должен выглядеть как синяя ссылка, на которую достаточно нажать. Если это не так, просто скопируйте этот адрес и вставьте его в строку адреса в верхней части окна своего браузера.
...
$string['backpackemailverifypending'] = 'Письмо с подтверждением отправлено по адресу <strong>{$a}</strong>. Воспользуйтесь ссылкой в письме для подтверждения и активации подключение к коллекции наград.';
$string['backpackemailverifysuccess'] = 'Благодарим за подтверждение Вашего адреса электронной почты. Теперь Вы подключены к Вашей коллекции наград.';
...
$string['backpackneedsupdate'] = 'Коллекция наград, связанная с этим профилем, не соответствует коллекции наград для сайта. Вам необходимо отключить и снова подключить коллекцию наград.';
...
$string['criteria_9'] = 'Компетенции';
$string['criteria_9_help'] = 'Позволяет присуждать значок пользователям на основе достигнутых ими компетентностей.';
