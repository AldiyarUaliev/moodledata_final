...
/**
 * Strings for component 'moodleoverflow', language 'ru', version '3.10'.
 *
...
$string['bestanswer'] = 'Автор вопроса и преподаватель курса приняли это как лучший ответ.';
...
$string['headerdiscussion'] = 'Обсуждение';
$string['headerlastpost'] = 'Последнее сообщение';
$string['headerreplies'] = 'Ответы';
$string['headerstartedby'] = 'Начато';
$string['headerstatus'] = 'Статус';
$string['headerunread'] = 'Не прочитано';
$string['headervotes'] = 'Голоса';
$string['helpfulanswer'] = 'Автор вопроса признал это лучшим ответом.';
...
$string['solvedanswer'] = 'Это сообщение помечено как решение.';
