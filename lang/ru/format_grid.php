...
/**
 * Strings for component 'format_grid', language 'ru', version '3.10'.
 *
 * @package     format_grid
 * @category    string
...
$string['cannotgetimagesforcourse'] = 'Не удается получить изображения курса. Пожалуйста, сообщите подробности ошибки разработчику.';
$string['centre'] = 'Центр';
...
$string['defaultcurrentselectedsectioncolour'] = 'Цвет выбранного раздела';
$string['defaultcurrentselectedsectioncolour_desc'] = 'Цвет выбранного раздела';
...
$string['defaultnewactivity_desc'] = 'Показывать изображение-уведомление о новых элементах, когда новый элемент или ресурс добавлен в раздел';
$string['deleteimage'] = 'Удалить изображение';
$string['deleteimage_help'] = 'Удалить изображение для редактируемого раздела. Если на этой форме загружено новое изображение, оно не заменит предыдущее.';
...
$string['resetallimagecontainerstyle'] = 'оформление области изображения';
...
$string['setbordercolour_help'] = 'Установить цвет границы в шестнадцатиричном RGB';
$string['setborderradius'] = 'Устанавить скругление углов вкл / выкл';
$string['setborderradius_help'] = 'Устанавливает скругление углов вкл или выкл';
...
$string['setcurrentselectedsectioncolour'] = 'Установить цвет для выбранного раздела';
$string['setcurrentselectedsectioncolour_help'] = 'Устанавливает цвет для выбранного раздела в шестнадцатиричном RGB';
...
$string['setimageresizemethod_help'] = 'Устанавливает способ изменения размера  как "Масштабирование" или "Обрезка" для соответствия области изображения.';
$string['setnewactivity'] = 'Показывать изображение-уведомление о новых элементах';
$string['setnewactivity_help'] = 'Показывает изображение-уведомление о новых элементах, когда новый элемент курса или ресурс добавляет в раздел';
