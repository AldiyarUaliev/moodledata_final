...
/**
 * Strings for component 'qtype_calculated', language 'ru', version '3.10'.
 *
...
$string['answerdisplay'] = 'Отобразить ответ';
$string['answerformula'] = 'Формула ответа {$a}';
...
$string['privacy:metadata'] = 'Плагин «Тип вопроса Вычисляемый» не хранит никаких персональных данных.';
