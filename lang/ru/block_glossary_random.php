...
/**
 * Strings for component 'block_glossary_random', language 'ru', version '3.10'.
 *
...
$string['glossary_random:myaddinstance'] = 'Добавлять новый блок «Случайная запись из глоссария» на страницу «Личный кабинет»';
...
$string['whichfooter'] = 'Вы можете отобразить ссылки на действия в глоссарии, с которым связан блок. Блок отобразит только те действия, которые доступны для этого глоссария.';
