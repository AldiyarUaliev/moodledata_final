...
/**
 * Strings for component 'repository_nextcloud', language 'ru', version '3.10'.
 *
...
$string['oauth2serviceslink'] = '<a href="{$a}" title="Link to OAuth 2 services configuration">Конфигурация служб OAuth 2 /a>';
