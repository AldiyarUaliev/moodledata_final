...
/**
 * Strings for component 'moodle', language 'ru', version '3.10'.
 *
 * @package     moodle
 * @category    string
...
$string['actionsfor'] = 'Действия для {$a}';
...
$string['addactivitytosection'] = 'Добавить элемент курса в секцию «{$a}»';
...
$string['addnew'] = 'Добавить новый {$a}';
...
$string['addresourcetosection'] = 'Добавить ресурс в секцию «{$a}»';
...
$string['aftersection'] = 'После секции «{$a}»';
...
$string['allactivities'] = 'Все элементы';
...
$string['backupadhocpending'] = 'Отложенное задание резервного копирования курса';
...
$string['calltofeedback'] = 'Создатели этого программного обеспечения хотели бы получить от Вас отзыв.';
$string['calltofeedback_give'] = 'Оставить отзыв об этом программном обеспечении';
$string['calltofeedback_remind'] = 'Напомнить мне позже';
...
$string['checksok'] = 'Пройдены все проверки - {$a}';
...
$string['contentexport_aboutthiscourse'] = 'Краткое содержание курса';
$string['contentexport_coursesummary'] = 'Этот файл является частью содержимого, загруженного из курса <a href="{$a->courselink}">{$a->coursename}</a>.';
$string['contentexport_footersummary'] = 'Этот файл является частью содержимого, загруженного из курса <a href="{$a->courselink}">{$a->coursename}</a> пользователем {$a->userfullname} в {$a->date}.';
$string['contentexport_modulesummary'] = 'Эта страница является частью контента, загруженного из <a href="{$a->modulelink}">{$a->modulename}</a> в {$a->date}. Обратите внимание, что некоторый контент и любые файлы размером больше {$a->maxfilesize} не загружаются.';
$string['contentexport_viewfilename'] = 'Посмотреть файл {$a}';
...
$string['copycourse'] = 'Копировать курс';
...
$string['coursedisplay_multi'] = 'Показывать одну секцию на странице';
$string['coursedisplay_single'] = 'Показывать все секции на одной странице';
...
$string['coursehelphiddensections'] = 'Как скрытые секции курса отображаются для студентов.';
...
$string['coursesectionsummaries'] = 'Описания секций курса';
...
$string['defaulthomepageuser'] = 'Домашняя страница';
$string['defaulthomepageuser_help'] = 'Ваша домашняя страница является первой ссылкой в навигации.';
...
$string['descriptiona'] = 'Описание: {$a}';
$string['deselectall'] = 'Убрать выделение';
$string['deselectnos'] = 'Отменить все «Нет»';
...
$string['dismissnotification'] = 'Отклонить это уведомление';
...
$string['dndnotsupported_help'] = 'Ваш браузер не поддерживает  загрузку методом перетаскивания фалов. Эта функция доступна во всех последних версиях Chrome, Firefox и Safari, а также Internet Explorer 10 и выше.';
...
$string['dndworkingfile'] = 'Для загрузки файлов перетащите их в секции курса';
$string['dndworkingfilelink'] = 'Для загрузки файлов или ссылок перетащите их в секции курса';
$string['dndworkingfiletext'] = 'Для загрузки файлов или текста перетащите их в секции курса';
$string['dndworkingfiletextlink'] = 'Для загрузки файлов, текста или ссылок перетащите их в секции курса';
$string['dndworkinglink'] = 'Для загрузки ссылок перетащите их в секции курса';
$string['dndworkingtext'] = 'Для загрузки текста перетащите их в секции курса';
$string['dndworkingtextlink'] = 'Для загрузки текста или ссылок перетащите их в секции курса';
...
$string['editsectionname'] = 'Редактировать название секции';
...
$string['emaildisplaycourse'] = 'Разрешить видеть мой адрес электронной почты только участникам курса';
...
$string['emailstop'] = 'Отключить уведомления';
...
$string['emojicategoryactivities'] = 'Мероприятия';
$string['emojicategoryanimalsnature'] = 'Животные и природа';
$string['emojicategoryflags'] = 'Флаги';
$string['emojicategoryfooddrink'] = 'Еда и питьё';
$string['emojicategoryobjects'] = 'Предметы';
$string['emojicategoryrecent'] = 'Последний';
$string['emojicategorysmileyspeople'] = 'Смайлики и люди';
$string['emojicategorysymbols'] = 'Символы';
$string['emojicategorytravelplaces'] = 'Путешествия и места';
...
$string['eventdatabasetextfieldcontentreplaced'] = 'База данных глобального поиска и замены';
...
$string['eventuserfeedbackgiven'] = 'Переход по ссылке «Оставить отзыв об этом программном обеспечении»';
$string['eventuserfeedbackremind'] = 'Переход по ссылке «Напомнить мне позже»';
...
$string['eventuserpasswordpolicyfailed'] = 'Пароль пользователя не соответствует политике паролей';
...
$string['extendsession'] = 'Продлить сессию';
...
$string['forcepasswordresetfailurenotice'] = 'Ваш текущий пароль больше не соответствует установленной политике паролей. Пожалуйста, обратитесь к администратору Moodle за помощью.
    {$a}';
$string['forcepasswordresetnotice'] = 'Ваш текущий пароль больше не соответствует установленной политике паролей. Вы должны сбросить пароль для входа
    {$a}';
...
* Секции по темам - Страница курса представляется в виде секций по темам.
* Секции по неделям - Страница курса представляется в виде секций, разбитых по неделям. Первая неделя отсчитывается от даты начала курса.';
...
$string['hiddensections_help'] = 'Этот параметр определяет, будут ли скрытые секции отображаться для студентов в свернутом виде (например, чтобы в курсе с форматом по неделям отметить каникулы) или они будут полностью скрыты.';
...
$string['hidesection'] = 'Скрыть секцию {$a}';
...
$string['idnumbermod'] = 'Идентификатор (ID)';
...
$string['idnumbertaken'] = 'Это значение ID уже занято';
...
$string['increasesections'] = 'Увеличить количество секций';
...
$string['indicator:activitiesdue'] = 'Активность';
$string['indicator:activitiesdue_help'] = 'У пользователя есть активность';
$string['indicator:anycourseaccess'] = 'Доступные курсы';
$string['indicator:anycourseaccess_help'] = 'Этот индикатор показывает все курсы, к которым есть доступ у пользователя.';
...
$string['indicator:anywriteincourse_help'] = 'Этот показатель представляет собой любое действие записи (отправки), совершенное студентом в любом элементе курса.';
...
$string['indicator:completeduserprofiledef'] = 'Профиль пользователя заполнен';
$string['indicator:completeduserprofiledef_help'] = 'Правила сайта были приняты и пользователь заполнил следующие поля: Учреждение, Отдел, Адрес, Город, Страна, URL.';
...
$string['indicator:nostudent'] = 'Регистрация студентов';
$string['indicator:nostudent_help'] = 'Данный показатель отображает, что на этом курсе нет студентов';
$string['indicator:noteacher'] = 'Наличие преподавателя';
$string['indicator:noteacher_help'] = 'Данный показатель отображает, что на этом курсе нет преподавателей';
...
$string['indicator:potentialcognitivedef'] = 'Потенциальная глубина познания курса';
$string['indicator:potentialcognitivedef_help'] = 'Степень, в которой курс предлагает «глубокое» когнитивное взаимодействие, например, представление работы для обратной связи, возможность проверить работу других, а также возможность пересмотреть и повторно представить работу.';
...
$string['indicator:potentialsocialdef'] = 'Потенциальная социальная ширина курса';
$string['indicator:potentialsocialdef_help'] = 'Степень, в которой курс предлагает «широкую» социальную вовлеченность, взаимодействие с другими участниками и с социальной практикой вне класса.';
...
$string['lastpage'] = 'Последняя страница';
...
$string['managecontentbanktypes'] = 'Управление типами контента';
...
$string['markedthistopic'] = 'Эта секция выделена как текущая';
...
$string['maxnumberweeks'] = 'Максимальное количество секций';
...
$string['messageprovider:asyncbackupnotification'] = 'Уведомления об асинхронном резервном копировании/восстановлении';
...
$string['messageprovider:coursecompleted'] = 'Курс завершен';
...
$string['messageprovider:gradenotifications'] = 'Уведомления об оценках';
$string['messageprovider:infected'] = 'Уведомления о сбоях антивируса.';
...
$string['modulesused'] = 'Используемые модули';
...
$string['morehelpaboutmodule'] = 'Подробная справка об элементе курса «{$a}»';
...
$string['movecoursesection'] = 'Переместить секцию';
...
$string['movesection'] = 'Переместить секцию «{$a}»';
...
$string['newsectionname'] = 'Новое название для секции {$a}';
...
$string['noteachingupcomingcourses'] = 'В этих курсах нет преподавателей или студентов';
...
$string['numberweeks'] = 'Количество секций';
$string['numday'] = '{$a} д.';
$string['numdays'] = '{$a} дн.';
$string['numhours'] = '{$a} ч.';
...
$string['orphanedactivitiesinsectionno'] = 'Потерянные элементы курса (секция {$a})';
$string['other'] = 'Другие';
...
$string['passwordpolicynomatch'] = 'Ваш текущий пароль больше не соответствует установленной политике паролей.
    {$a}';
...
$string['privacy:metadata:oauth2_refresh_token'] = 'Токен обновления, используемый при обмене данными OAuth 2.0';
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'ID эмитента, которому соответствует токен';
$string['privacy:metadata:oauth2_refresh_token:scopehash'] = 'ID пользователя, которому соответствует токен';
$string['privacy:metadata:oauth2_refresh_token:timecreated'] = 'Время создания токена';
$string['privacy:metadata:oauth2_refresh_token:timemodified'] = 'Время последнего обновления токена';
$string['privacy:metadata:oauth2_refresh_token:token'] = 'Токен обновления для соответствующих областей и пользователя';
$string['privacy:metadata:oauth2_refresh_token:userid'] = 'ID пользователя, которому соответствует токен';
$string['privacy:metadata:task_adhoc'] = 'Состояние разовых задач.';
...
$string['privacy:metadata:task_log'] = 'Журнал для событий';
$string['privacy:metadata:task_log:component'] = 'Компонент, на который возложена задача.';
$string['privacy:metadata:task_log:userid'] = 'Пользователь, которому принадлежит задача.';
...
$string['recommended'] = 'Рекомендуемые';
$string['recreatedcategory'] = 'Пересоздать категорию {$a}';
$string['redirect'] = 'Перенаправление';
$string['reducesections'] = 'Уменьшить количество секций';
...
$string['registrationyes'] = 'Да, сообщать мне о новых выпусках Moodle, предупреждениях безопасности и других важных новостях';
$string['reject'] = 'Отклонить';
$string['rejectdots'] = 'Отклонить...';
$string['relativedatesmode'] = 'Режим относительных дат';
$string['relativedatesmode_help'] = 'Отображение даты начала курса или мероприятия относительно даты начала курса пользователя.

Дата начала курса пользователя будет датой его регистрации, если только он не зарегистрирован до начала курса, и в этом случае датой начала будет дата начала курса.

ПРЕДУПРЕЖДЕНИЕ: Это экспериментальная функция, и не все элементы и ресурсы могут ее поддерживать. После создания курса эту настройку изменить нельзя.';
$string['relativedatesmode_warning'] = '<strong>Предупреждение:</strong> Режим относительных дат не может быть изменен после создания курса.';
...
$string['resultsfound'] = 'Найдено результатов: {$a}';
...
$string['searchactivities'] = 'Поиск элементов и ресурсов по названию или описанию';
...
$string['searchcoursecategories'] = 'Категории поиска';
...
$string['separateandconnectedinfo'] = 'Шкала основана на теории независимого и связного познания. Эта теория описывает два различных способа изучения и оценки вещей, которые мы видим и о которых слышим.<ul><li>Те, кто познают мир <strong>независимо</strong>, остаются, насколько возможно, объективными без учета своих чувств и эмоций. В обсуждениях с другими людьми, у которых могут быть другие взгляды, им нравится защищать свои собственные идеи с использованием логики, чтобы найти слабые места в суждениях соперника. </li><li>Те же, кто познают мир <strong>связанно</strong> более восприимчивы к другим людям. Они умеют сопереживать и склонны слушать и задавать вопросы, пока не почувствуют, что нашли связь и начали «понимать вещи с другой точки зрения». Они учатся, пытаясь заимствовать опыт и знания, которые они находят в других людях. </li></ul>';
...
$string['sessiontimeoutsoon'] = 'Ваш сеанс истекает. Вы хотите продлить текущую сессию?';
...
$string['showadvancededitor'] = 'Расширенная форма ответа';
...
$string['showingacourses'] = 'Отображаются все курсы - {$a}';
...
$string['sitedefaultspecified'] = 'Сайт по умолчанию ({$a})';
...
$string['sites'] = 'Сайты';
$string['sitesection'] = 'Включить секцию курса';
...
$string['sizekb'] = 'Кбайт';
$string['sizemb'] = 'Мбайт';
$string['sizepb'] = 'Петабайт';
$string['sizetb'] = 'Терабайт';
...
$string['statsreport14'] = 'Самые активные курсы (сообщения/просмотры)';
...
$string['statuscritical'] = 'Критический';
...
$string['summary_help'] = 'Описание - это небольшой текст, рассказывающий студентам о дальнейшей деятельности в рамках этой секции (темы или недели). Текст отображается на странице курса под названием секции.';
...
$string['timesplitting:deciles'] = 'Последняя десятая доля';
...
$string['timesplitting:decilesaccum'] = 'Все предыдущие десятые';
...
$string['timesplitting:nosplitting'] = 'Нет ограничений по времени';
$string['timesplitting:nosplitting_help'] = 'Для этой модели не определен метод разделения по времени.';
$string['timesplitting:onemonthafterstart'] = 'Через месяц после начала';
$string['timesplitting:onemonthafterstart_help'] = 'Этот интервал анализа даст прогноз через 1 месяц после начала анализа.';
$string['timesplitting:oneweekafterstart'] = 'Через одну неделю после начала';
$string['timesplitting:oneweekafterstart_help'] = 'Этот интервал анализа даст прогноз через 1 неделю после начала анализа.';
$string['timesplitting:past3days'] = 'Последние 3 дня';
...
$string['timesplitting:quartersaccum'] = 'Все предыдущие четверти';
...
$string['timesplitting:singlerange'] = 'От начала до конца';
$string['timesplitting:singlerange_help'] = 'Этот метод разбиения по времени рассматривает весь курс как один интервал.';
$string['timesplitting:tenpercentafterstart'] = '10% после начала';
$string['timesplitting:tenpercentafterstart_help'] = 'Этот интервал анализа генерирует прогноз после завершения 10% курса.';
$string['timesplitting:upcoming3days'] = 'Следующие 3 дня';
$string['timesplitting:upcoming3days_help'] = 'Этот интервал анализа генерирует прогнозы каждые 3 дня. Показатели расчетов будут основаны на следующих 3 днях.';
$string['timesplitting:upcomingfortnight'] = 'Следующие две недели';
$string['timesplitting:upcomingfortnight_help'] = 'Этот интервал анализа генерирует прогнозы каждые две недели. Показатели расчетов будут основаны на следующих двух неделях.';
$string['timesplitting:upcomingweek'] = 'Следующая неделя';
$string['timesplitting:upcomingweek_help'] = 'Этот интервал анализа генерирует прогнозы каждую неделю. Показатели расчетов будут основаны на следующей неделе.';
...
$string['toggleemojipicker'] = 'Переключить выбор эмодзи';
$string['togglesearch'] = 'Изменить данные поисковой строки';
...
$string['topic'] = 'Тема';
$string['topichide'] = 'Скрыть эту секцию от пользователей с ролью «{$a}»';
$string['topicoutline'] = 'Тематический план';
$string['topicshow'] = 'Показать эту секцию пользователям с ролью «{$a}»';
$string['toplevelcategory'] = 'Категория верхнего уровня';
$string['total'] = 'Итог';
$string['totopofsection'] = 'К началу секции "{$a}"';
...
$string['youhaveupcomingactivitiesdue'] = 'У вас есть предстоящие задания';
$string['youhaveupcomingactivitiesdueinfo'] = 'Привет {$a},

<br/><br/>У вас есть элементы курсов с приближающимся сроком сдачи:';
