...
/**
 * Strings for component 'resource', language 'ru', version '3.10'.
 *
 * @package     resource
 * @category    string
...
$string['showdate_desc'] = 'Отображать дату загрузки/изменения на странице курса?';
$string['showdate_help'] = 'Отображает дату загрузки/изменения рядом со ссылкой на файл.

Если в этом ресурсе несколько файлов, то будет отображена дата загрузки/изменения первого файла.';
...
Если ресурс содержит несколько файлов, то будет отображаться общий объем всех файлов.';
