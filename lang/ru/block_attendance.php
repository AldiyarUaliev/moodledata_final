...
/**
 * Strings for component 'block_attendance', language 'ru', version '3.10'.
 *
...
$string['privacy:metadata'] = 'Блок «Посещаемость» только показывает имеющиеся данные о посещаемости.';
