...
/**
 * Strings for component 'studentquiz', language 'ru', version '3.10'.
 *
 * @package     studentquiz
 * @category    string
...
$string['messageprovider:approved'] = 'Уведомление об одобрении вопроса';
$string['messageprovider:changed'] = 'Уведомление об изменении вопроса';
...
$string['messageprovider:deleted'] = 'Уведомление о удаленном вопросе';
$string['messageprovider:disapproved'] = 'Уведомление об отклонении вопроса';
$string['messageprovider:hidden'] = 'Уведомление о скрытом вопросе';
$string['messageprovider:minecommentdeleted'] = 'Уведомление "Мой комментарий удален"';
$string['messageprovider:unhidden'] = 'Уведомление об открытии вопроса';
...
$string['studentquiz:emailnotifydeleted'] = 'Уведомление об удалении вопроса';
