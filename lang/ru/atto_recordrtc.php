...
/**
 * Strings for component 'atto_recordrtc', language 'ru', version '3.10'.
 *
...
$string['allowedtypes'] = 'Разрешенные типы';
$string['allowedtypes_desc'] = 'Какие кнопки записи должны появиться в Atto. В дополнение к этой настройке, есть также возможности, которые могут управлять доступом к кнопкам для определенных пользователей в определенных контекстах.';
...
$string['audiortc'] = 'Записать аудио';
...
$string['gumnotfound'] = 'Устройство входа не подключено или не включено';
...
$string['gumnotsupported'] = 'Ваш браузер не поддерживает запись по небезопасному соединению и должен закрыть плагин';
...
$string['gumsecurity'] = 'Ваш браузер не поддерживает запись по небезопасному соединению и должен закрыть плагин';
...
$string['nearingmaxsize'] = 'Вы достигли максимального размера файла для загрузки';
$string['nearingmaxsize_title'] = 'Запись остановлена';
$string['norecordingfound'] = 'Кажется что-то пошло не так, похоже ничего не записалось';
...
$string['videortc'] = 'Записать видео';
