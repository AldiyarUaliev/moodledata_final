...
/**
 * Strings for component 'enrol_imsenterprise', language 'ru', version '3.10'.
 *
...
$string['categoryidnumber_desc'] = 'Если включено, то IMS Enterprise создаст категорию с номером id';
