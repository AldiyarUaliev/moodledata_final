...
/**
 * Strings for component 'stampcoll', language 'ru', version '3.10'.
 *
 * @package     stampcoll
 * @category    string
...
$string['errtextlength'] = 'Текст слишком длинный';
$string['eventstampadded'] = 'Штамп задан';
$string['eventstampdeleted'] = 'Штамп удалён';
$string['eventstampgranted'] = 'Штамп получен';
$string['eventstampupdated'] = 'Штамп обновлен';
