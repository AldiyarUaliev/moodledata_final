...
/**
 * Strings for component 'block_admin_bookmarks', language 'ru', version '3.10'.
 *
...
$string['privacy:metadata'] = 'Блок «Закладки администратора» только показывает данные, хранящиеся в других местах.';
